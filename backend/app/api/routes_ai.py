...
def _generate_deterministic_explanation(payload: ExplainRequest, sim_result: Optional[SimulationResult] = None) -> ExplainResponse:
    ...
    or explains the active circuit step-by-step when Gemini is unconfigured, unreachable, or times out.
    """
...
def explain(payload: ExplainRequest) -> ExplainResponse:
    ...
    # 2. Fallback to deterministic engine if Gemini is unconfigured, unreachable, or times out
